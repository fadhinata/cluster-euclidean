 ...
 * @author Matt
 */
public class TestPlainClusterCalculator {
    
    private static final Logger log = Logger.getLogger(TestPlainClusterCalculator.class);
    ...
    public static void init() {
        ...
        cluster = PlainClusterCalculator.getInstance();
        cluster.process();
    }
